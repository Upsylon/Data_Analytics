...
In order to propose an optimal model that could be used for predictions, we begin with an explanatory analysis to better understand our data. Based on it, we will already be able to have some assumptions about which variables might be the most important one.
...
More than seeing the first values of our variables and their types, we also need to understand how distributed they are and their link with the response variable.  

We can appreciate the summary of the different variables. The frequency table of *history* is presented below as an example:  
